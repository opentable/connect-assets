...
(function() {
  ...
  module.exports = exports = function(options) {
    ...
    if ((_ref12 = options.writeFileSync) == null) {
  ...
  ConnectAssets = (function() {
    ...
    ConnectAssets.prototype.createHelpers = function() {
      var context, expandRoute, parseAttributes, srcIsRemote,
        _this = this;
      ...
      parseAttributes = function(routeOptions) {
        var attrs, name, value;
        attrs = [];
        for (name in routeOptions) {
      ...
      context.css = function(route, routeOptions) {
        ...
        resCSS = _this.compileCSS(route);
        if (typeof resCSS === 'undefined') {
          return;
        }
        if (!route.match(REMOTE_PATH)) {
          route = _this.options.servePath + resCSS;
        }
      ...
      context.js = function(route, routeOptions) {
        var attrs, p, r, routes, scripts, _i, _len;
        if (routeOptions == null) {
          routeOptions = {};
        }
        attrs = [];
        ...
        if (alreadyCached && this.options.build) {
          ...
          if (this.options.buildDir) {
            ...
            mkdirRecursive(path.dirname(buildPath), 0x1ed, function() {
              return _this.writeFile(buildPath, img);
            });
          }
        ...
        try {
          ...
          if (alreadyCached && this.options.build) {
            ...
            if (this.options.buildDir) {
              buildPath = path.join(process.cwd(), this.options.buildDir, filename);
              mkdirRecursive(path.dirname(buildPath), 0x1ed, function() {
                return _this.writeFile(buildPath, css);
              });
            }
            return this.cachedRoutePaths[route] = "/" + filename;
          } else {
              ...
              if (changed) {
                ...
                if (buildDir = _this.options.buildDir) {
                  ...
                  return mkdirRecursive(path.dirname(buildPath), 0x1ed, function(err) {
                    return _this.writeFile(buildPath, concatenation);
                  });
                }
              } else {
    ...
    ConnectAssets.prototype.writeFile = function(filename, data) {
      if (this.options.writeFileSync) {
